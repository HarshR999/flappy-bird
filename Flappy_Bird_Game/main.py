...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('Flappy Bird by Harsh')
    ...
    GAME_SPRITES['message'] = pygame.image.load('Image/massage.jpg').convert_alpha()
    GAME_SPRITES['base'] = pygame.image.load('Image/base.png').convert_alpha()
